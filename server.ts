...
/* 0.9.0: which surfaces the accent colors (kv `accentOptions`). Reads always
   ...
   0.9.5 adds groups (project group shading). */
const options = z.object({ headings: z.boolean(), threads: z.boolean(), rails: z.boolean(), hover: z.boolean(), header: z.boolean(), wash: z.boolean(), input: z.boolean(), groups: z.boolean() } satisfies Record<(typeof ACCENT_OPTION_KEYS)[number], z.ZodBoolean>);
